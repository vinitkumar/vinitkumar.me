...
const AboutIndex  = (props) => {
  ...
  return (
    ...
    />
    <p>
      My name is <strong>Vinit Kumar</strong>, and I'm a Software Engineer.<br/>
      <br/>
      I am mainly interested in designing and building highly scalable systems in Python, Node.js, and Go. I like writing code in Vim/NeoVim and a good coffee to start my day. In this website, you will find my writing on a variety of topics.
    </p>

    <p>Currently, I lead the development and architecture of a multi-tenant & distributed CMS at Socialschools B.V. I have more than 8 years of experience writing backend in Django for a couple of successful product and numerous client projects. You can download my <a target='_blank'  rel="noopener noreferrer"  href="https://vinitkumar.github.io/vinit_kumar.pdf"> resume</a> here. My biggest strength is in coming up with simple solutions for difficult problems.
    </p>
