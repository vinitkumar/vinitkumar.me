...
const AboutIndex  = (props) => {
  ...
  return (
    ...
    <p>
      ...
      <br/>
      Designing and building highly scalable systems in Python, Node.js, and Go. I like writing code in Vim and a good coffee to start my day. 
    </p>

    <p>I lead the development and architecture of a multi-tenant & distributed CMS at Socialschools B.V. I have 9 years of experience writing backend in Django for a couple of successful products and numerous client projects. You can download my <a target='_blank'  rel="noopener noreferrer"  href="https://vinitkumar.github.io/vinit_kumar.pdf"> resume</a> here. My strength is in coming up with simple solutions for difficult problems.
    </p>
