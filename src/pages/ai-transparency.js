  ...
  return (
    <Layout location={location} title="AI Transparency">
      ...
      <p>
        ...
        Claude, ChatGPT, or GitHub Copilot to help with editing, proofreading, or brainstorming ideas,
        but the core ideas and writing are my own.
      </p>
      
      <h2>Code</h2>
      <p>
        I use AI-assisted coding tools (like GitHub Copilot and Claude) to help write code faster.
