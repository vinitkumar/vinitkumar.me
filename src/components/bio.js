...
const Bio = () => {
  return (
    ...
    >
      <p>
        I’m a <Link to="/about" className="btn-action">Principal Engineer</Link> and <Link to="https://www.django-cms.org/en/blog/2024/11/07/welcoming-vinit-kumar-as-the-newest-django-cms-fellow/" className="btn-action">Django CMS Fellow</Link>  passionate about solving meaningful problems and pushing tech boundaries.
