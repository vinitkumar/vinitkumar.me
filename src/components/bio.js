...
const Bio = () => {
  ...
  return (
    ...
    >
      <p>
        I’m a{" "}
        <Link to="/about" className="btn-action-latest">
          Principal Engineer
        </Link>{" "}
        at{" "}
        <a className="btn-action-latest" href="https://scalefusion.com">
          Scalefusion
        </a>{" "}
        and a{" "}
        <a
          href="https://www.django-cms.org/en/blog/2024/11/07/welcoming-vinit-kumar-as-the-newest-django-cms-fellow/"
          className="btn-action-latest"
        >
          Django CMS Fellow
        </a>
        . I build useful software, maintain open source, and write about what I
        learn. Away from code, I read, play music, make art, and appreciate a
        good cup of coffee.
      </p>
      <p>
        Read what former colleagues have said in my{" "}
        <Link className="btn-action-latest" to="/recommendations">
          recommendations
        </Link>
        , view my{" "}
        <a
        ...
        or email{" "}
        <a href="mailto:mail@vinitkumar.me" className="btn-action-latest">
          mail@vinitkumar.me
        </a>
        .
      </p>
      ...
      >
        ...
        <div
          style={{ marginBottom: "15px", fontSize: "13px", lineHeight: "1.3" }}
        >
          <div style={{ display: "flex", flexWrap: "wrap", gap: "12px" }}>
            ...
            <span>
              🔥 {mostActiveYear} ({yearStats[mostActiveYear]})
            </span>
            <span>
